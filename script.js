...
document.querySelector(".main-nav img").onclick = scrollUp = () => {
  document.querySelector('.landing-container').scrollIntoView({
    behavior: 'smooth'
  });
};
...
document.getElementById("arrow-container2").onclick = scrollDown2 = () => {
  ...
  let dropdownWrapperCenter = (dropdownWrapperBounding.y);

  window.scrollBy({
    top: dropdownWrapperCenter,
    left: 0,
    behavior: 'smooth'
  });
...
document.getElementById("skills-link").onclick = scrollDown2 = () => {
  ...
  if (mobileDevice === false) {
    ...
    window.scrollBy({
      top: dropdownWrapperCenterMobile,
      left: 0,
      behavior: 'smooth'
    });
  }
